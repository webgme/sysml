...
/**
 * Generated by PluginGenerator 0.14.0 from webgme on Wed Feb 24 2016 10:28:52 GMT-0600 (Central Standard Time).
 */

'use strict';
var testFixture = require('../../globals');

describe('LayoutExporter', function () {
    var gmeConfig = testFixture.getGmeConfig(),
        expect = testFixture.expect,
        logger = testFixture.logger.fork('NewPlugin'),
        PluginCliManager = testFixture.WebGME.PluginCliManager,
        projectName = 'testProject',
        pluginName = 'LayoutExporter',
        project,
        gmeAuth,
        storage,
        commitHash;
